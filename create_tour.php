            ...
            <div class="col-lg-8">
                <div class="sidebar-box ftco-animate">
                    <div class="search-tours bg-light p-4">
                        <h3>Create Your tour</h3>
                        <form action="insert_tour.php" method="post" enctype="multipart/form-data">
                            <div class="fields">
                                <div class="row">

                                    <div class="textfield-search col-sm-12 group mb-3"><input type="text" name="title" class="form-control" placeholder="Tour Location"></div>
                                    ...
                                    <div class="check-in col-sm-4 group mb-3"><input type="text"  name="age" class="form-control" placeholder="Minimum Age"></div>
                                    <div class="check-in col-sm-4 group mb-3"><input type="text"  name="min_member" class="form-control" placeholder="Minimum Member"></div>

                                    <div class="check-out col-sm-4 group mb-3"><input type="text"  name="max_member" class="form-control" placeholder="Maximum Member"></div>
                                    <div class="check-out col-sm-4 group mb-3"><input type="text"  name="cost" class="form-control" placeholder="Tour Total Cost"></div>
                                    ...
                                    <div class="col-sm-12 group mb-3">
                                        <input type="submit" class="search-submit btn btn-primary" value="Create Tour">
                                    </div>
                                </div>
                            </div>
                        </form>
